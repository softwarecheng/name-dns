...
type MyUtxoValueInDB struct {
	...
	AddressIds  []uint64   `protobuf:"varint,3,rep,packed,name=address_ids,json=addressIds,proto3" json:"address_ids,omitempty"`
	Ordinals    []*MyRange `protobuf:"bytes,4,rep,name=ordinals,proto3" json:"ordinals,omitempty"`
}
...
var file_common_pb_ordinals_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x22, 0x9e, 0x01, 0x0a, 0x0f, 0x4d,
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x64,
	0x64, 0x72, 0x65, 0x73, 0x73, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x04, 0x52,
	0x0a, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x49, 0x64, 0x73, 0x12, 0x2e, 0x0a, 0x08, 0x6f,
	0x72, 0x64, 0x69, 0x6e, 0x61, 0x6c, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e,
	0x70, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4d, 0x79, 0x52, 0x61, 0x6e, 0x67,
	0x65, 0x52, 0x08, 0x6f, 0x72, 0x64, 0x69, 0x6e, 0x61, 0x6c, 0x73, 0x42, 0x0c, 0x5a, 0x0a, 0x2f,
...
var file_common_pb_ordinals_proto_goTypes = []interface{}{
...
func file_common_pb_ordinals_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_common_pb_ordinals_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_pb_ordinals_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
